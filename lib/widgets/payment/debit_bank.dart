...
class DebitBankPaymentWidget extends StatelessWidget {
  ...
  DebitBankPaymentWidget({this.invoicePayment});
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: '${DateFormat("dd-MM-yyyy, HH:mm").format(invoicePayment.expiryDate)}',
            ...
            children: [
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      '${invoicePayment.debitBank.bankCode}',
              ...
              Container(
                ...
                child: Text(
                  '${invoicePayment.debitBank.bankBranch == "Virtual Account" ? 'No. Virtual Account' : 'No. Rekening'}',
                  style: PadiMallTextTheme.sz13weight500(context),
                ),
              ),
              Row(
                ...
                children: [
                  Text(
                    '${invoicePayment.debitBank.bankAccountNumber}',
                    style: PadiMallTextTheme.sz14weight600(context),
                  ),
                  GestureDetector(
                    onTap: () {
                      FlutterClipboard.copy(invoicePayment.debitBank.bankAccountNumber).then((value) => Fluttertoast.showToast(
